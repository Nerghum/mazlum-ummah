...
const PHOTO_GRID = [
  "/assets/posts/image-copy-6.png",
  "/assets/posts/image-copy-7.png",
  "/assets/posts/image-copy-8.png",
  "/assets/posts/image-copy-9.png",
  "/assets/posts/image-copy-10.png",
    ...
    <div className="social-sidebar">
      ...
      <div className="sidebar-share-container">
        ...
        <div className="sidebar-share-buttons-stack">
          <button
            ...
            aria-label="Facebook"
          >
            <span className="sidebar-share-loading"></span>
            <svg
          ...
          >
            ...
            <span className="sidebar-share-ripple"></span>
          </button>
          <button
            className="sidebar-share-btn"
            tabIndex={0}
      ...
      <div className="sidebar-donation-wrapper">
        <div className="sidebar-donation-card">
          ...
          <a
            className="sidebar-donation-btn-primary"
            tabIndex={0}
            id=":r3d:"
            href="/donate"
            data-discover="true"
          ...
          <a
            className="sidebar-donation-btn-secondary"
            tabIndex={0}
            id=":r3e:"
      ...
      <div className="sidebar-section photos-section">
        <div className="photos-section__header">
          ...
          <a href="/gallery" className="photos-section__link">
            See all photos
          </a>
        </div>
      ...
      {/* Ad Banner - Synced with News Details */}
