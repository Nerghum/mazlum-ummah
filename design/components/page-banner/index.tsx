...
const PageBanner = ({
  ...
  const renderAd = (isDesktop: boolean) => {
    ...
    const className = isDesktop
      ? "page-banner__ad-img page-banner__ad-img-desktop"
      : "page-banner__ad-img page-banner__ad-img-mobile";
    return (
      <Image
        src={src}
  ...
  return (
    <section
      className={`page-banner ${title ? "page-banner--has-title" : ""} ${adImageUrl ? "page-banner--has-ad" : ""}`.trim()}
    >
