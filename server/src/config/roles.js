...
export const permissions = {
  'Super Admin': ['*'],
  Admin: ['dashboard:read', 'news:*', 'blog:*', 'mediaAchievement:*', 'socialPost:*', 'notice:*', 'advertisement:*', 'menu:*', 'faq:*', 'category:*', 'country:*', 'media:*', 'homepage:*', 'analytics:*', 'settings:*', 'newsletter:*'],
  Editor: ['dashboard:read', 'news:*', 'blog:*', 'mediaAchievement:*', 'socialPost:*', 'notice:*', 'media:*', 'category:read', 'country:read', 'newsletter:read'],
