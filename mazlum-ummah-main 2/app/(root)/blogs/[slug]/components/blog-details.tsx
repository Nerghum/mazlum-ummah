        ...
        <div className="MuiGrid2-root MuiGrid2-direction-xs-row MuiGrid2-grid-xs-12 MuiGrid2-grid-lg-7.7 css-1ezbg89">
          <div className="MuiBox-root css-1fobf8d">
            ...
            <div className="blog-details-meta">
              <span className="blog-details-meta-text">৯ মে, ২০২৬</span>
              <span className="blog-details-meta-text">{t("media.writtenBy")}: মোহাম্মদ রাজ</span>
            </div>
          </div>
          <div className="MuiBox-root css-1fobf8d">
            ...
            <div className="MuiBox-root css-relevant-blogs">
              ...
              <div className="relevant-blogs-list">
                {[
                  {
                    date: "১০ মার্চ, ২০২৬",
                    title: "২০ দিনব্যাপী দাওয়াহ প্রশিক্ষণ-২০২৬ সম্পন্ন",
                    excerpt:
                      "সফলভাবে সম্পন্ন হয়েছে ২০ দিনব্যাপী দাওয়াহ প্রশিক্ষণ-২০২৬। মযলুম উম্মাহের অঙ্গপ্রতিষ্ঠান মযলুম উম্মাহ দাওয়াহ অ্যান্ড রিসার্চ ইনস্টিটিউটের উদ্যোগে অনুষ্ঠিত হয়েছে এই প্রশিক্ষণ।",
                    url: "/blogs/dawahtraining2026",
                  },
                  {
                    date: "১৬ মার্চ, ২০২৫",
                    title: "মাসব্যাপী দাওয়াহ প্রশিক্ষণ-২০২৫ সম্পন্ন",
                    excerpt:
                      "মযলুম উম্মাহের উদ্যোগে মাসব্যাপী দাওয়াহ প্রশিক্ষণ-২০২৫ সফলভাবে সম্পন্ন হয়েছে। প্রশিক্ষণার্থীদের মধ্যে ৫০ জনকে সনদ প্রদান করা হয়।",
                    url: "/blogs/dawahtraining2025",
                  },
                  {
                    date: "১৯ এপ্রিল, ২০২৬",
                    title: "দুই পর্বে অনুষ্ঠিত হলো হজ প্রশিক্ষণ কর্মশালা-২০২৬",
                    excerpt:
                      "মযলুম উম্মাহের ব্যবস্থাপনায় ২০২৬ সালের হজযাত্রীদের জন্য আয়োজিত বিশেষ প্রশিক্ষণ কর্মশালা দুই পর্বে সফলভাবে সম্পন্ন হয়েছে।",
                    url: "/blogs/hajj-training",
                  },
                ].map((blog, index) => (
                  <a href={blog.url} key={index} className="relevant-blog-link">
